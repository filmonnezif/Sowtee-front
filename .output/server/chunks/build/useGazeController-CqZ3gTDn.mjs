...
function updateFocusedElement(element) {
  const selectableElement = element == null ? void 0 : element.closest("[data-gaze-selectable]");
...
function registerTarget(id, element, priority = 0, options = {}) {
  ...
  targets.value.set(id, {
    ...
    priority,
    weight: (_b = (_a = options.weight) != null ? _a : existing == null ? void 0 : existing.weight) != null ? _b : 1,
    lastSelectedTime: (_c = existing == null ? void 0 : existing.lastSelectedTime) != null ? _c : 0,
    selectionCount: (_d = existing == null ? void 0 : existing.selectionCount) != null ? _d : 0
  });
}
...
function findBestTarget(x, y) {
  ...
  if (bestCandidate.target.id !== (candidateTarget == null ? void 0 : candidateTarget.id)) {
...
export { useEyeGaze as a, useGazeController as b, useCamera as u };
//# sourceMappingURL=useGazeController-CqZ3gTDn.mjs.map
