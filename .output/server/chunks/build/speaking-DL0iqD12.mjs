...
import { u as useSpeechRecognition, _ as __nuxt_component_1 } from './SettingsSidebar-Dc35XKMD.mjs';
import { defineComponent, ref, watch, nextTick, computed, mergeProps, unref, useSSRContext } from 'vue';
...
import { a as useAppStore, b as useI18n, d as defineStore, n as navigateTo } from './server.mjs';
import { u as useApi } from './useApi-DXXljJZv.mjs';
import { a as useEyeGaze, b as useGazeController } from './useGazeController-CqZ3gTDn.mjs';
...
const useSpeakingStore = defineStore("speaking", {
  ...
  getters: {
    ...
    primarySuggestion(state) {
      var _a;
      return ((_a = state.expansion) == null ? void 0 : _a.primary) || null;
    },
    // Alternative suggestions (shown at top)
    alternativeSuggestions(state) {
      var _a;
      return ((_a = state.expansion) == null ? void 0 : _a.alternatives) || [];
    },
  ...
  actions: {
    ...
    navigateHighlight(direction) {
      ...
      if (count === 0) return;
      let current = (_a = this.highlightedIndex) != null ? _a : -1;
      if (direction === "up") {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(speakingStore).error) {
        _push(`<div class="error-toast" data-v-cd63e96c>${ssrInterpolate(unref(speakingStore).error)} <button data-v-cd63e96c>\xD7</button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_GazeCursor, {
...
export { speaking as default };
//# sourceMappingURL=speaking-DL0iqD12.mjs.map
