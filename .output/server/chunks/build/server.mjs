...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CJdB3NAD.mjs')
  },
  {
    name: "profile",
    path: "/profile",
  ...
  },
  {
    name: "speaking",
    path: "/speaking",
    component: () => import('./speaking-BmmXvOEM.mjs')
  },
  {
    name: "onboarding",
    path: "/onboarding",
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/-5e_Yf1E"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/-5e_Yf1E"}/${locale}/messages.json`));
