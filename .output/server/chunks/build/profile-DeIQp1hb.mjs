  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(profile2.value.interests, (interest, idx) => {
        _push(`<span class="tag" data-v-000d5c18>${ssrInterpolate(interest)} <button class="tag-remove" data-v-000d5c18>\xD7</button></span>`);
      });
      ...
      ssrRenderList(profile2.value.common_needs, (need, idx) => {
        _push(`<span class="tag" data-v-000d5c18>${ssrInterpolate(need)} <button class="tag-remove" data-v-000d5c18>\xD7</button></span>`);
      });
...
//# sourceMappingURL=profile-DeIQp1hb.mjs.map
