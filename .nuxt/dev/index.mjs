...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, setCookie, removeResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///home/filmon/Sowtee/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/filmon/Sowtee/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/filmon/Sowtee/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withTrailingSlash, decodePath, withoutTrailingSlash } from 'file:///home/filmon/Sowtee/frontend/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/filmon/Sowtee/frontend/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/filmon/Sowtee/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/filmon/Sowtee/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/filmon/Sowtee/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/filmon/Sowtee/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/filmon/Sowtee/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/filmon/Sowtee/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/filmon/Sowtee/frontend/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/filmon/Sowtee/frontend/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/filmon/Sowtee/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/filmon/Sowtee/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/filmon/Sowtee/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/filmon/Sowtee/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/filmon/Sowtee/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/filmon/Sowtee/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/filmon/Sowtee/frontend/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file:///home/filmon/Sowtee/frontend/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/filmon/Sowtee/frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/filmon/Sowtee/frontend/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/filmon/Sowtee/frontend/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/filmon/Sowtee/frontend/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/filmon/Sowtee/frontend/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/filmon/Sowtee/frontend/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/filmon/Sowtee/frontend/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/filmon/Sowtee/frontend/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/filmon/Sowtee/frontend","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/filmon/Sowtee/frontend/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/filmon/Sowtee/frontend/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/filmon/Sowtee/frontend/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/filmon/Sowtee/frontend/.data/kv"}));
...
const _9uJTEZYsDv3_Uc4t0jIAWkhMbMnDYQY5beXEAsKjt4 = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"SOWTEE - The Self-Learning, Context-Aware Agentic Communication Bridge for AAC"}],"link":[],"style":[],"script":[],"noscript":[],"title":"SOWTEE - صوتي","htmlAttrs":{}};
...
const _9xbT2sdJ0mOBRgffapnPZVe3I1h04h5eqSnboKfSY = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/fgkHvXUh") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const rootDir = "/home/filmon/Sowtee/frontend";
...
const _YoeXx4Rzs5S2ElgdReWLozDHVK1f3rzz3e79xT7Q4Y = (nitroApp) => {
...
const plugins = [
  _9uJTEZYsDv3_Uc4t0jIAWkhMbMnDYQY5beXEAsKjt4,
_9xbT2sdJ0mOBRgffapnPZVe3I1h04h5eqSnboKfSY,
_YoeXx4Rzs5S2ElgdReWLozDHVK1f3rzz3e79xT7Q4Y
];
...
const _gSGHHN = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/filmon/Sowtee/frontend/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/filmon/Sowtee/frontend/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _KJ8cAe = _messagesHandler ;

const _lazy_g3YzQ5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _gSGHHN, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_g3YzQ5, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _KJ8cAe, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_g3YzQ5, lazy: true, middleware: false, method: undefined }
];
...
var home$1 = {
	skills: {
		speaking: {
			title: "التحدث",
			desc: "اكتب باستخدام بطاقات الحروف وتحدث بمساعدة الذكاء الاصطناعي"
		},
		email: {
			title: "البريد الإلكتروني",
			desc: "إنشاء وإرسال رسائل البريد الإلكتروني بمساعدة الكتابة"
		},
		social: {
			title: "وسائل التواصل",
			desc: "النشر والتفاعل على منصات التواصل الاجتماعي"
		}
	},
	hint: "اضغط مسافة أو إدخال لبدء التحدث",
	calibration: {
		title: "تابع المؤشر بعينيك أثناء النقر على الأزرار",
		done: "تم"
	}
};
var speaking$1 = {
	placeholder: "اختر الحروف للكتابة...",
	actions: {
		backspace: "رجوع",
		enter: "توسيع",
		loading: "جارِ التوسيع..."
	},
	suggestions: {
		speak: "تحدث",
		back: "رجوع",
		hintCycle: "انظر لأعلى/لأسفل للتنقل بين الكلمات",
		hintActions: "يسار للرجوع، يمين للتحدث"
	}
};
var settings$1 = {
	title: "الإعدادات",
	...
	general: {
		...
		eyeGaze: {
			title: "إعدادات نظرة العين",
			calibrated: "تمت المعايرة",
			notCalibrated: "لم تتم المعايرة",
			recalibrate: "إعادة المعايرة",
			calibrate: "معايرة",
			dwellTime: "وقت التثبيت",
			dwellHint: "المدة التي يجب النظر فيها إلى الهدف قبل تحديده",
			openMode: "فتح وضع نظرة العين",
			tip: "انظر إلى الهدف لمدة التثبيت لتحديده. ارمش للتأكيد."
		},
	...
	sceneContext: {
		title: "سياق المشهد",
		placeholder: "سيتم التقاط المشهد عند التحدث",
		capture: "التقاط الآن",
		capturing: "جارِ الالتقاط...",
		recapture: "إعادة التقاط المشهد",
		analyzing: "جارِ تحليل المشهد...",
		failed: "فشل التحليل",
		captured: "تم التقاط المشهد"
	},
	listening: {
		title: "الاستماع",
		start: "بدء",
		active: "نشط",
		lastHeard: "آخر ما سمع:",
		listeningPlaceholder: "انتظار الكلام...",
		enablePlaceholder: "تفعيل لسماع المحادثة"
	},
	situation: {
		title: "الموقف",
		placeholder: "مثال: في هاكاثون أعرض تطبيقنا...",
		quickContexts: {
			hackathon: "هاكاثون",
			doctor: "طبيب",
			restaurant: "مطعم"
	...
	cameras: {
		title: "الكاميرات",
		webgazer: "كاميرا تتبع العين",
		sceneCapture: "كاميرا التقاط المشهد",
		"default": "الكاميرا الافتراضية",
		noCameras: "لم يتم العثور على كاميرات",
		available: "{count} كاميرات متاحة"
	},
	colors: {
		"default": "افتراضي",
		slate: "سليت",
...
var profile = {
	...
	fields: {
		...
		commonNeeds: "الاحتياجات الشائعة",
		dailyRoutine: "الروتين اليومي"
	},
	placeholders: {
		displayName: "اسمك",
		location: "المدينة أو البلد",
		selectCondition: "اختر الحالة...",
		caregiverName: "اسم مقدم الرعاية الرئيسي",
		interests: "اكتب واضغط إدخال",
		commonNeeds: "اكتب واضغط إدخال",
		dailyRoutine: "صف يومك المعتاد...",
		notes: "أي شيء آخر يجب أن يعرفه المساعد..."
	},
	stages: {
		early: "مبكرة",
		moderate: "متوسطة",
	...
	living: {
		...
		careHome: "دار رعاية",
		independentAide: "مستقل مع مساعد",
		independent: "مستقل"
	}
};
const ar = {
