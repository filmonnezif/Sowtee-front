...
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, unref, useSlots, Fragment, createVNode, Text, defineAsyncComponent, Suspense, mergeProps, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/filmon/Sowtee/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/filmon/Sowtee/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/filmon/Sowtee/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/home/filmon/Sowtee/frontend/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu, createDefu } from "/home/filmon/Sowtee/frontend/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parsePath, parseQuery, withoutTrailingSlash } from "/home/filmon/Sowtee/frontend/node_modules/ufo/dist/index.mjs";
import { klona } from "/home/filmon/Sowtee/frontend/node_modules/klona/dist/index.mjs";
...
import { complex, number as number$1, alpha, filter, px, progressPercentage, degrees, scale, color } from "style-value-types";
import { parse as parse$1 } from "/home/filmon/Sowtee/frontend/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/home/filmon/Sowtee/frontend/node_modules/destr/dist/index.mjs";
import { isEqual } from "/home/filmon/Sowtee/frontend/node_modules/nuxt/node_modules/ohash/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/filmon/Sowtee/frontend/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Bbs005DM.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-DeIQp1hb.js")
  },
  {
    name: "learning",
    path: "/learning",
    component: () => import("./_nuxt/learning-CZ3bm67v.js")
  },
  {
    name: "speaking",
    path: "/speaking",
    component: () => import("./_nuxt/speaking-DcABVBUr.js")
  }
];
...
function useEventListener(...args) {
  ...
  const firstParamTargets = computed(() => {
    const test = toArray$2(toValue(args[0])).filter((e) => e != null);
...
function directive(variants, isPreset = false) {
  ...
  return {
    ...
    getSSRProps(binding, node) {
      ...
      const initial = defu$1({}, variants?.initial || {}, bindingInitial || {});
  ...
  en: [
    {
      ...
      load: () => import(
        "./_nuxt/en-C1ZjN0fh.js"
        /* webpackChunkName: "locale_en_46json_8739d7a6" */
      ),
      cache: true
    }
  ],
  ar: [
    {
      ...
      load: () => import(
        "./_nuxt/ar-CDPCMOVq.js"
        /* webpackChunkName: "locale_ar_46json_f79bc02e" */
      ),
      cache: true
    }
  ],
  ur: [
    {
      ...
      load: () => import(
        "./_nuxt/ur-vg1HcYyq.js"
        /* webpackChunkName: "locale_ur_46json_06002deb" */
      ),
      cache: true
    }
  ]
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BVlpQhBA.js").then((m) => m.default || m))
};
...
const useAppStore = /* @__PURE__ */ defineStore("app", {
  ...
  getters: {
    ...
    detectedObjects: (state) => state.visualContext?.detected_objects.map((o) => o.label) || [],
  ...
  actions: {
    ...
    setSceneCapture(image, description) {
    ...
    setEyeGazeOverlay(active) {
      this.eyeGazeOverlayActive = active;
    },
    setDwellThreshold(ms) {
      this.dwellThreshold = Math.max(500, Math.min(ms, 5e3));
    },
    ...
    setListeningToSpeech(listening) {
    ...
    setCustomContextEnabled(enabled) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CKDpqQHK.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BrWqFk8Q.js"));
