import { defineComponent, mergeProps, unref, createVNode, resolveDynamicComponent, useSSRContext, ref, readonly, watch } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle } from "vue/server-renderer";
import { Hand, Eye, ToggleRight, Lightbulb, BookOpen, Target, Brain, Search, X, Languages, Mic, CheckCircle, Trash2, Upload, Loader2, Palette, Image, RefreshCw, Camera, FileText } from "lucide-vue-next";
import { a as useAppStore, b as useI18n, f as useNuxtApp } from "../server.mjs";
import { a as useEyeGaze, b as useGazeController, u as useCamera } from "./useGazeController-CqZ3gTDn.js";
...
function useSpeechRecognition() {
  ...
  const initRecognition = () => {
    ...
    const SpeechRecognitionClass = (void 0).SpeechRecognition || (void 0).webkitSpeechRecognition;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function getCameraDisplayName(cameraId) {
      ...
      return camera2?.label || "Unknown Camera";
    }
    return (_ctx, _push, _parent, _attrs) => {
...
export {
  ...
  useSpeechRecognition as u
};
//# sourceMappingURL=SettingsSidebar-Dc35XKMD.js.map
